...
export default function App() {
  ...
  const inputUniform = inputBase + " w-48";
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-indigo-50 via-sky-50 to-white p-6 font-sans">
      <div className="max-w-6xl mx-auto space-y-6">
        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-800 text-center">Mini Expense Tracker</h1>
        <p className="text-center text-sm text-gray-500">Quickly log expenses and get simple visual insights.</p>

        {/* Summary Widgets */}
        <div className="flex flex-col items-center gap-4">
          <ul className="flex gap-6 md:gap-8 overflow-x-auto py-3 md:py-2 justify-center flex-nowrap mx-auto">
            {[
              ...
              <li
                key={item.key}
                className="min-w-60 md:min-w-60 backdrop-blur-sm p-4 rounded-xl shadow relative pl-4 flex flex-col items-center justify-center text-center space-y-1 mr-2"
    ...
    CSV
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6 lg:col-span-1">
            {/* Input Form */}
           <form onSubmit={handleSubmit} className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200 space-y-6 relative">
